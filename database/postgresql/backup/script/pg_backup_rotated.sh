...
####### LOAD CONFIG #######
###########################
export PGPASSWORD='dSlvAKWlZuNKWoa'
...
if [ -z $CONFIG_FILE_PATH ] ; then
        SCRIPTPATH="/data/backups/database/postgresql/script"
...
#Copy backup to backup VM
#echo "Sync backup"
#/bin/rsync -avz /data/backups/database/postgresql root@10.98.1.35:/data/backup/database/
