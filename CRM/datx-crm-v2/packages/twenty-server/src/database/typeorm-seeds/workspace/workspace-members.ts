...
export const seedWorkspaceMember = async (
    ...
    workspaceMembers = [
      {
        ...
        nameFirstName: 'Tester 01',
        nameLastName: 'DATX',
        locale: 'en',
        colorScheme: 'Light',
        userEmail: 'tester01@datx.com.vn',
        userId: DEV_SEED_USER_IDS.TIM,
      },
      {
        id: DEV_SEED_WORKSPACE_MEMBER_IDS.JONY,
        nameFirstName: 'Tester 02',
        nameLastName: 'DATX',
        locale: 'en',
        colorScheme: 'Light',
        userEmail: 'tester02@datx.com.vn',
        userId: DEV_SEED_USER_IDS.JONY,
      },
      {
        id: DEV_SEED_WORKSPACE_MEMBER_IDS.PHIL,
        nameFirstName: 'Tester 03',
        nameLastName: 'DATX',
        locale: 'en',
        colorScheme: 'Light',
        userEmail: 'tester03@datx.com.vn',
  ...
  if (workspaceId === SEED_TWENTY_WORKSPACE_ID) {
    workspaceMembers = [
      {
        id: DEV_SEED_WORKSPACE_MEMBER_IDS.TIM,
        nameFirstName: 'Tester 04',
        nameLastName: 'DATX',
        locale: 'en',
        colorScheme: 'Light',
        userEmail: 'tester04@datx.com.vn',
        userId: DEV_SEED_USER_IDS.TIM,
      },
    ];
  }
