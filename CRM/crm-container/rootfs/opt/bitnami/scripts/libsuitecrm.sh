...
suitecrm_enable_api_v8() {
    run_as_user "$WEB_SERVER_DAEMON_USER" cp "${BITNAMI_ROOT_DIR}/scripts/suitecrm/replacements/public/legacy/Api/V8/OAuth2/private.key" "${SUITECRM_BASE_DIR}/public/legacy/Api/V8/OAuth2/private.key"
    run_as_user "$WEB_SERVER_DAEMON_USER" cp "${BITNAMI_ROOT_DIR}/scripts/suitecrm/replacements/public/legacy/Api/V8/OAuth2/public.key" "${SUITECRM_BASE_DIR}/public/legacy/Api/V8/OAuth2/public.key"
}

suitecrm_update_files() {
    run_as_user "$WEB_SERVER_DAEMON_USER" rsync -vaz "${BITNAMI_ROOT_DIR}/scripts/suitecrm/replacements/" "${SUITECRM_BASE_DIR}/"
    run_as_user "$WEB_SERVER_DAEMON_USER" chmod 600 "${SUITECRM_BASE_DIR}/public/legacy/Api/V8/OAuth2/private.key"
    run_as_user "$WEB_SERVER_DAEMON_USER" chmod 600 "${SUITECRM_BASE_DIR}/public/legacy/Api/V8/OAuth2/public.key"
}

suitecrm_clean_cache() {
    run_as_user "$WEB_SERVER_DAEMON_USER" php "${SUITECRM_BASE_DIR}/bin/console" "cache:clear"
}
