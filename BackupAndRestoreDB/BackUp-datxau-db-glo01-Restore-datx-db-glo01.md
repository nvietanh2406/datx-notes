...
sed -n '/^-- Current Database: `mysql`/,/^-- Current Database: `/p' all-databases-datx-db-glo01-2024-07-15_19h45m.sql > mysqldb.sql

time mysql -u root -p  < mysqldb.sql

time mysql -u root -p < all-databases-datx-db-glo01-2024-07-15_19h45m.sql
...
CREATE USER 'ubuntu'@'192.168.0.100' IDENTIFIED BY 'Invoice@2019';
GRANT ALL ON *.* TO 'ubuntu'@'192.168.0.100';
FLUSH PRIVILEGES;
...
RESET SLAVE ALL;
        ...
        SOURCE_LOG_FILE='mysql-bin.000405',
        SOURCE_LOG_POS=96179;
...
mysqldump -u ubuntu -p  --databases commodity commodityDb globaldb hsx indices